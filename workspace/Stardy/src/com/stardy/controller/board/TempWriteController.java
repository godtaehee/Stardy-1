...
import com.stardy.service.FileService;
import com.stardy.service.FileServiceImpl;
import com.stardy.util.UploadUtil;

@WebServlet("/study/board/write")
@MultipartConfig(
    fileSizeThreshold = 1024*1024,
    maxFileSize = 1024*1024*50, //50메가
    maxRequestSize = 1024*1024*50*5 // 50메가 5개까지
)
public class TempWriteController extends HttpServlet{
